...
(5, 31, 2, 'Chompa de Alpaca Premium', 'Chompa tejida a mano con lana de alpaca 100% natural. Diseño tradicional andino.', 'chompa-alpaca-principal.png', 'inactivo', '2025-11-15 03:43:02'),
(6, 32, 2, 'Gorro Andino', 'Gorro tejido con diseños geométricos tradicionales. Protección contra el frío.', 'gorro.png', 'inactivo', '2025-11-15 03:43:02'),
(7, 33, 2, 'Manta Cusqueña', 'Manta artesanal de Cusco con tintes naturales. Ideal para decoración.', 'manta-cuque__a-principal.png', 'inactivo', '2025-11-15 03:43:02'),
(8, 16, 2, 'Ojotas', 'suela gruesa de neumático o llanta reciclado, con tiras del mismo material para sujetar el pie.', 'ojotas.png', 'activo', '2025-11-29 10:13:10'),
(9, 10, 2, 'Poncho Artesanal Corto', 'Poncho en colores surtidos, elaborado 100% en algodón, tamaño 120*72 cm, 240 gr', 'poncho.png', 'activo', '2025-11-29 10:37:33'),
(10, 29, 2, 'Quena', '', 'quena.png', 'activo', '2025-11-29 12:24:13'),
(11, 21, 2, 'Cinturón Mujer, Bordado a Mano en Perú, Lana Artesanal', '', 'cinturon-principal.png', 'activo', '2025-11-29 12:35:19'),
(12, 29, 2, 'Zampolla', '', 'zampolla-principal.png', 'activo', '2025-11-29 13:02:04'),
(13, 20, 2, 'Chalina', '', 'chalina-principal.png', 'activo', '2025-11-29 19:55:04');
...
(7, 5, 'S', 'Rojo', NULL, 150.00, 5, 'chompa-artesanal2.png', 'activo'),
(8, 5, 'M', 'Rojo', NULL, 150.00, 8, 'chompa-artesanal3.png', 'activo'),
(9, 5, 'L', 'Azul', NULL, 150.00, 7, NULL, 'activo'),
(10, 6, 'Única', 'Multicolor', NULL, 35.00, 25, 'gorro-artesanal-unixes.png', 'activo'),
(11, 6, 'Única', 'Verde', NULL, 35.00, 25, 'gorro-artesanal-unixes.png', 'activo'),
(12, 7, 'Grande', 'Natural', NULL, 80.00, 8, NULL, 'activo'),
(13, 7, 'Pequeña', 'Natural', NULL, 60.00, 7, NULL, 'activo'),
