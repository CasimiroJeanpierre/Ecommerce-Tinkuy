...
server {
    ...
    add_header Content-Security-Policy "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://www.google.com https://www.gstatic.com https://cdn.userway.org; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://cdn.userway.org; img-src 'self' data: https://cdn.jsdelivr.net https://www.google.com https://www.gstatic.com https://cdn.userway.org; font-src 'self' data: https://cdn.jsdelivr.net https://cdn.userway.org; frame-src https://www.google.com https://cdn.userway.org; connect-src 'self' https://api.userway.org https://cdn.userway.org; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self';" always;
